...
const endpoint = computed(() => {
  if (swaggerStore.swaggerJSON){
    return swaggerStore.swaggerJSON.find(e => e.path === "/api/locationInformation")
  }
})
...
<template>
    <div class="max-w-[700px]">
      ...
      <div class="flex flex-col gap-2 mt-4">
        ...
        <h3>Resource URL</h3>
        <div class="doc__url">
          <p><span class="font-bold">GET</span> /api/locationInformation</p>
        </div>
        ...
        <div class="flex flex-col mt-4 gap-4">
          <h2>XML vs JSON</h2>
          <div class="doc__url">
            <p><span class="font-bold">GET</span> /api/locationInformation?locationName=Bern&limit=1</p>
          </div>
